...
namespace Classifier.Tests
{
    ...
    class IFactoryTests
    {
        ...
        [TestCase("Многоквартирный дом с подземной автопарковкой", "2.5.0, 2.6.0")]
        ...
        [TestCase(@"участки размещения многоквартирных жилых домов: объекты размещения жилых и нежилых помещений, инженерного оборудования многоквартирных", "2.5.0, 2.6.0")]
        ...
        [TestCase(@"Многоквартирный дом", "2.5.0, 2.6.0")]
        ...
        [TestCase(@"квартал жилого типа низкоплотной застройки с высотой не более 15 м", "2.1.0, 2.2.0")]
