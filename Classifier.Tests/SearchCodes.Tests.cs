...
namespace Classifier.Tests
{
    ...
    public class ISearchCodesTests
    {
        ...
        [TestCase(@"эксплуатации существующего здания станции юных туристов", "5.2.0")]
        ...
        [TestCase(@"объекты размещения некоммерческих организаций, связанные с обслуживанием проживающего населения (1.2.17); объекты размещения финансово-кре", "3.2.1")]
        [TestCase(@"объекты размещения организаций и учреждений обеспечения безопасности (1.2.17)", "8.3.0")]
        [TestCase(@"объекты размещения помещений и технических устройств линейных объектов железнодорожного и скоростного внеуличного транспорта, тяговых", "7.1.2")]
        ...
        [TestCase(@"ПРОЕКТИРОВАНИЯ, СТРОИТЕЛЬСТВА И ПОСЛЕДУЮЩЕЙ ЭКСПЛУАТАЦИИ СТАЦИОНАРНОГО ТЕХНИЧЕСКОГО ПОСТА ПО ЗАМЕНЕ И СБОРУ ОТРАБОТАННЫХ АВТОМОБИЛЬНЫХ", "12.3.0")]
        ...
        [TestCase(@"РАЗВИТИЯ И ЭКСПЛУАТАЦИИ РЕЗИДЕНЦИИ ПАТРИАРХОВ МОСКОВСКИХ И ВСЕЯ РУСИ, ЦЕНТРА ПРАВОСЛАВНОГО НАСЛЕДИЯ, СТРОИТЕЛЬСТВА И ДАЛЬНЕЙШЕЙ ЭКСПЛУА", "3.6.1")]
        ...
        [TestCase(@"РАЗРАБОТКИ ИСХОДНО-РАЗРЕШИТЕЛЬНОЙ И ПРОЕКТНОЙ ДОКУМЕНТАЦИИ, СТРОИТЕЛЬСТВА И ДАЛЬНЕЙШЕЙ  ЭКСПЛУАТАЦИИ МНОГОФУНКЦИОНАЛЬНОГО АДМИНИСТРАТ", "4.1.0")]
        ...
        [TestCase(@"гидротехнические сооружения (11.3) (земельные участки улиц, проспектов, площадей, шоссе, аллей, бульваров, застав, переулков, проездов, тупико", "11.3.0")]
        [TestCase(@"дальнейшей эксплуатации существующих зданий и сооружений 5-го района водопроводной сети, без права возведения капитальных строений и соо", "3.1.3")]
        ...
        [TestCase(@"размещение сооружений, имеющих назначение по временному хранению, распределению и перевалке грузов (за исключением хранения стратегичес", "3.9.5")]
        ...
        [TestCase(@"участки размещения стационарно-профилактических учреждений (в т.ч. клинических) без специальных требований к размещению (1.2.17); участки раз", "9.2.1.0")]
        [TestCase(@"участки размещения учебно-восспитательных объектов: объекты размещения учреждений кружковой деятельности и учреждений для организации", "3.5.1.0, 3.6.1")]
        ...
        [TestCase(@"эксплуатации зданий кафедры оперативной хирургии.", "3.4.2.0")]
