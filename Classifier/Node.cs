        ...
        private void Feeding()
        {
            ...
            nodes.Add(new Agriculture("1.0.0", "1.0", "3006", "800",
                ...
                new string[] {
                    ...
                    @"",
                    @"\b(для\s*)?сельскохоз\w*\s*цел\w*\b",
            ...
            nodes.Add(new Housing("2.1.0", "2.1", "2001", "200",
               ...
               new string[] {
                    ...
                    @"",
                    @"\bдомовладен\w*\b|\b(низко|средне)застройки с высотой не более 15",
            ...
            nodes.Add(new Housing("2.2.0", "2.2", "2001", "200",
               ...
               new string[] {
                    ...
                    @"",
                    @"\bмалоэтаж\w*\s*(застрой\w*|строит\w*)\b|\b(низко|средне)плотной застройки с высотой не более 15",
            ...
            nodes.Add(new HParking("2.7.1.0", "2.7.1", "3004", "300",
               ...
               new string[] {
                    ...
                    @"\bподземн\w*\s*(авто)?парковк\w*\b|\bгараж\w*\s*бокс\w*\b",
            ...
            nodes.Add(new Transport("7.1.2", "7.1", "3005", "300",
               ...
               new string[] {
                    ...
                    @"",
                    @"\bтранспортн\w*\s*инфраструктур\w*\b.*\b(желе[зж]н\w*|" +
            ...
            nodes.Add(new Transport("7.2.2", "7.2", "3001", "300",
            ...
            nodes.Add(new Transport("7.3.0", "7.3", "7000", "300",
            ...
            nodes.Add(new Transport("7.4.1", "7.4", "6000", "300",
            ...
            nodes.Add(new Transport("7.4.2", "7.4", "3005", "300",
            ...
            nodes.Add(new SecurityForces("8.4.0", "8.4", "3003", "300",
               ...
               new string[] {
                    ...
                    @"",
                    @"\bгауптвахт\w*\b|\bохран\w*\s*спецконтингент\w*\b" }
               ));
            ...
            nodes.Add(new OtherFunction("12.3.0", "12.3", "9000", "900",
               ...
               new string[] {
                    ...
                    @"",
                    @"для\sиного\sиспользован|\bдля\s*иных\s*целей\b",
